        ...
        NavigationStack{
            VStack(alignment: .leading){
                ...
                HStack{
                    Text("Periode")
                    Spacer()
                    Text("Periode").font(.system(size: 16,weight: .bold, design: .rounded)).foregroundColor(.black)
                }.padding(.horizontal, 16).padding(.bottom, 16)
                HStack{
                    Text("Tagihan")
                    Spacer()
...
struct BpjsResultView_Previews: PreviewProvider {
