        ...
        NavigationStack{
            VStack(alignment: .leading){
                ...
                HStack{
                    Text("Tarif/Daya")
                    Spacer()
                    Text("R1/1300VA").font(.system(size: 16,weight: .bold, design: .rounded)).foregroundColor(.black)
                }.padding(.horizontal, 16).padding(.bottom, 16)
                HStack{
                    Text("Tagihan")
                    Spacer()
...
struct PlnResultView_Previews: PreviewProvider {
